import {createRouteDispatcher} from "../provider-api";
...
describe("routeDispatcher", () => {
  test("receiveRoute and addRouteListener work together", () => {
    ...
    let thing = null;
    routeDispatcher.addRouteListener((r) => { thing = r });
    //when
  ...
  test("currentRoute returns the correct route object", () => {
    ...
    routeDispatcher.receiveLocation(createLocation("/bar/hi"))
    //then
    expect(routeDispatcher.currentRoute).toEqual({routeName: "bar", id: "hi"});
